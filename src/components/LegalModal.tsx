...
export function LegalModal({ type, onClose }: LegalModalProps) {
  return (
    ...
    >
      ...
      {/* モーダル本体 */}
      <div
        className="relative w-full max-w-lg bg-white/30 backdrop-blur-2xl border border-white/30 border-l-4 border-l-white/80 rounded-3xl p-8 shadow-2xl max-h-[80vh] overflow-y-auto"
